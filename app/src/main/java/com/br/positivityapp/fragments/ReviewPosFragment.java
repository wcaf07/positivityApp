...
public class ReviewPosFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_review_pos, container, false);
        ((MainActivity) getActivity()).setActionBarTitle("Positivity App");
        calendarView = (MaterialCalendarView) root.findViewById(R.id.calendarView3);

        calendarView.setOnDateChangedListener(new OnDateSelectedListener() {
            @Override
            public void onDateSelected(@NonNull MaterialCalendarView widget, @NonNull CalendarDay date, boolean selected) {
                listener.onSwitchToNextSecondFragment(date);
            }
        });
